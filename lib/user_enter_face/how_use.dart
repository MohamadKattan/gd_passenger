...
class HowToUse extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            appBar: AppBar(
                backgroundColor: const Color(0xFF00A3E0), elevation: 0.0),
            body: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(AppLocalizations.of(context)!.st1,
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(AppLocalizations.of(context)!.st3,
                        style: const TextStyle(
                            color: Color(0xFF00A3E0),
                            fontSize: 16,
                            fontWeight: FontWeight.bold)),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(AppLocalizations.of(context)!.st4,
                        style: const TextStyle(
                            color: Color(0xFF00A3E0),
                            fontSize: 16,
                            fontWeight: FontWeight.bold)),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(AppLocalizations.of(context)!.st5,
                        style: const TextStyle(
                            color: Color(0xFF00A3E0),
                            fontSize: 16,
                            fontWeight: FontWeight.bold)),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(AppLocalizations.of(context)!.st6,
