...
class AntalyVeto extends StatefulWidget {
  const AntalyVeto({Key? key}) : super(key: key);

  @override
  State<AntalyVeto> createState() => _AntalyVetoState();
}

class _AntalyVetoState extends State<AntalyVeto> {
