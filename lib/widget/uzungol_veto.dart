...
class UzungolVeto extends StatefulWidget {
  const UzungolVeto({Key? key}) : super(key: key);

  @override
  State<UzungolVeto> createState() => _UzungolVetoState();
}

class _UzungolVetoState extends State<UzungolVeto> {
